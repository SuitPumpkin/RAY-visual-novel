...
define config.name = _("RAYos con que asi es el MUNDO")
...
define build.name = "RAYosconqueasieselMUNDO"
...
define config.save_directory = "RAYosconqueasieselMUNDO-1762451163"
